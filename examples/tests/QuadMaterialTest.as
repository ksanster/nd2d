	...
	public class QuadMaterialTest extends Scene2D {
		...
		override protected function step(elapsed:Number):void {
			...
			colorQuad.topLeftColor = ColorUtil.colorWithAlphaFromColor(
												ColorUtil.mixColors(0xFF0000, 0x00FF00, NumberUtil.sin0_1(seconds * 2.2)),
												NumberUtil.sin0_1(seconds * 2.3)
											);

			colorQuad.topRightColor = ColorUtil.colorWithAlphaFromColor(
												ColorUtil.mixColors(0x00FF00, 0x0000FF, NumberUtil.sin0_1(seconds * 2.4)),
												NumberUtil.sin0_1(seconds * 2.5)
											);
			colorQuad.bottomLeftColor = ColorUtil.colorWithAlphaFromColor(
												ColorUtil.mixColors(0xFF00FF, 0xFFFF00, NumberUtil.sin0_1(seconds * 2.6)),
												NumberUtil.sin0_1(seconds * 2.7)
											);

			colorQuad.bottomRightColor = ColorUtil.colorWithAlphaFromColor(
												ColorUtil.mixColors(0x00FF99, 0x9900FF, NumberUtil.sin0_1(seconds * 2.8)),
												NumberUtil.sin0_1(seconds * 2.9)
											);
		}
	}
}
