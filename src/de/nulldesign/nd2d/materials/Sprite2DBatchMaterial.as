...
// use first two faces and extend facelist to max. batch size
        ...
        protected function processAndRenderNodes(context:Context3D, childList:Vector.<Node2D>):void {
            ...
            while(++i < n) {
                ...
                childMC = childNode as MovieClip2D;
                ...
                if(child && child.visible) {
                    ...
                    if(childMC != null && spriteSheet != null) {

                        uvOffsetAndScale = childMC.spriteSheet.getUVRectForFrame(texture.textureWidth, texture.textureHeight);

                        var offset:Point = childMC.spriteSheet.getOffsetForFrame();

                        clipSpaceMatrix.identity();
                        clipSpaceMatrix.appendScale(childMC.spriteSheet.spriteWidth >> 1, childMC.spriteSheet.spriteHeight >> 1, 1.0);
